    ...
    reducers: {
        filterByCuisine: (state, action) => {
            ...
            if (action.payload === "") {
                ...
                state.filteredRecipes = recipes.filter(recipe => recipe.cuisine === action.payload);
            }
        },
        filterByMealType: (state, action) => {
            ...
            if (action.payload === "") {
                ...
                state.filteredRecipes = recipes.filter(recipe => recipe.mealType.includes(action.payload));
            }
        },
        filterByDifficulty: (state, action) => {
            ...
            if (action.payload === "") {
                ...
                state.filteredRecipes = recipes.filter(recipe => recipe.difficulty === action.payload);
            }
        },
        clearFilters: (state) => {
...
export const { filterByCuisine, filterByMealType, filterByDifficulty, clearFilters } = recipeSlice.actions;
